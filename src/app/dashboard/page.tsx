              ...
              for (const p of activePeriods) {
                  ...
                  if (now >= expectedDate) {
                    ...
                    if (!hasPaid) {
                      generatedReminders.push({
                        ...
                        description: `שכר דירה מאת ${tenant.name} לחודש זה (₪${p.monthlyRent}) ממתין לגבייה.`,
                ...
                if (diffDays >= 0 && diffDays <= 60) {
                  generatedReminders.push({
                    ...
                    description: `חוזה השכירות של ${tenant.name} מסתיים בעוד ${diffDays} ימים.`,
                    date: p.endDate,
                    propertyId: prop.id,
                    tenantId: tenant.id,
                    periodId: p.id
                ...
                if (p.renewalDeadline) {
                  ...
                  if (deadlineDiffDays >= 0 && deadlineDiffDays <= 30) {
                    generatedReminders.push({
                      ...
                      description: `המועד האחרון להודעה על אופציה של ${tenant.name} בעוד ${deadlineDiffDays} ימים.`,
